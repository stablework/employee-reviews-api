...
Create a REST API service that allows their employees to give reviews of the projects they’re working on, their team members and manager. It should fulfil the following requirements:
...
We'll also be assessing your database design, code readability, best practices, security & testing.

Rename this README to “instructions”, and build a useful README allowing any user to run the project. Build a git repository, and share maintainer access with the maintainers mentioned in the e-mail.
